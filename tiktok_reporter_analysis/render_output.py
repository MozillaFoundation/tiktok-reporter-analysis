...
def generate_html_report(results_dir):
    ...
    merged_df = events_df.merge(descriptions_df[["video_file", "video", "description"]], on="video", how="left")
